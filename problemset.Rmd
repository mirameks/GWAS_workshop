...
### we could experiment to see how nearby genes could be affected by the drug and how that affects gene regulation. We could experiment again with a more uniform group with close to the same genetic makeup to exclude confounding variables.
